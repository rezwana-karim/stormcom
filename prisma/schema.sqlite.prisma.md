...
model Store {
  ...
  name           String
  slug           String   @unique
  subdomain      String?  @unique  // Subdomain for multi-tenant routing (e.g., vendor1, vendor2)
  customDomain   String?  @unique  // Custom domain for CNAME routing (e.g., vendor.com)
  description    String?
  logo           String?
  email          String
  phone          String?
...
// Store Staff - Store-level role assignments
model StoreStaff {
  id        String   @id @default(cuid())
  userId    String
  storeId   String
...
model AuditLog {
  ...
  action    String   // e.g., "CREATE", "UPDATE", "DELETE", "PERMISSION_CHECK", "PERMISSION_DENIED"
  entityType String  // e.g., "Product", "Order", "User", "Permission"
  entityId  String
  ...
  // Permission tracking
  permission String?  // Permission being checked (e.g., "stores:create")
  role       String?  // User's role at time of action
  allowed    Boolean? // Permission check result (true/false/null)
