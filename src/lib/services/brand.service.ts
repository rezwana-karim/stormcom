...
// Validation schemas (using cuid instead of uuid)
...
export class BrandService {
  ...
  /**
   * Alias for createBrand
   */
  async create(storeId: string, data: CreateBrandData): Promise<BrandWithRelations> {
    return this.createBrand(storeId, data);
  }

  /**
   * Alias for getBrandById
   */
  async getById(storeId: string, brandId: string): Promise<BrandWithRelations | null> {
    return this.getBrandById(brandId, storeId);
  }

  /**
   * Alias for getBrandBySlug
   */
  async getBySlug(storeId: string, slug: string): Promise<BrandWithRelations | null> {
    return this.getBrandBySlug(slug, storeId);
  }
}
